...
function menuChange() {
    ...
    if (cururl.indexOf("ticket-admin") > -1) {
        document.getElementById("m2").setAttribute("aria-expanded", "true");
        document.getElementById("menu2").className = "panel-collapse collapse in";
        document.getElementById("menu_ticket_admin").className = "active";
        document.getElementById("menu_ticket_admin").style.color = "#fff";
        document.getElementById("menu_ticket_admin").style.backgroundColor = "#252525";
    }
}
