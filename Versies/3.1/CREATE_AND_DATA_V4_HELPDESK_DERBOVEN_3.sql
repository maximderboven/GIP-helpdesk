...
INSERT INTO `tblantwoorden` VALUES (9,'x',4,8,'2020-04-15 16:41:20'),(10,'Dit is een ticket van gebruiker2',5,9,'2020-04-15 16:58:53'),(11,'Dit is een ticket van gebruiker3',6,10,'2020-04-15 16:59:17'),(12,'Dit is een ticket van gebruiker4',7,11,'2020-04-15 16:59:51'),(13,'Klopt, Ik ben admin2.',8,11,'2020-04-15 17:03:01'),(14,'Correct, je mag deze sluiten alstublieft.',7,11,'2020-04-15 17:03:59'),(15,'x',7,12,'2020-04-15 17:21:02'),(16,'Wat is je vraag ?',2,10,'2020-04-15 17:38:21'),(17,'Ik vroeg me af of dit mogelijk is ?',6,10,'2020-04-15 17:38:57'),(18,'Tuurlijk.',2,10,'2020-04-15 17:39:39');
...
INSERT INTO `tblmeldingen` VALUES (3,2,1,'xxxx','2020-04-14 20:57:45'),(4,2,1,'love yu','2020-04-14 20:57:58'),(5,4,1,'Een admin heeft je profiel aangepast.','2020-04-15 12:55:34'),(6,4,1,'Een admin heeft je ticket aangepast.','2020-04-15 13:07:35'),(7,4,1,'Een admin heeft je profiel aangepast.','2020-04-15 14:05:10'),(8,4,1,'Een admin heeft je profiel aangepast.','2020-04-15 15:04:30'),(9,4,1,'Een admin heeft je ticket aangepast.','2020-04-15 16:40:28'),(10,4,0,'Een admin heeft je ticket aangepast.','2020-04-15 16:45:44'),(11,7,1,'Een admin heeft je ticket aangepast.','2020-04-15 17:11:05'),(12,6,1,'Je hebt een nieuwe reactie op je ticket.','2020-04-15 17:38:21'),(13,6,1,'Je hebt een nieuwe reactie op je ticket.','2020-04-15 17:39:39'),(14,6,1,'Een admin heeft je ticket aangepast.','2020-04-15 17:39:46');
...
CREATE TABLE `tbltickets` (
  ...
  KEY `fk_tbltickets_tblgebruikers2_idx` (`adminID`),
  ...
  CONSTRAINT `fk_tbltickets_tblgebruikers2` FOREIGN KEY (`adminID`) REFERENCES `tblgebruikers` (`id`),
...
INSERT INTO `tbltickets` VALUES (8,2,'x',1,'2020-04-15 16:41:20',NULL,4,2),(9,5,'Dit is een ticket van gebruiker2',1,'2020-04-15 16:58:53',NULL,5,NULL),(10,3,'Dit is een ticket van gebruiker3',3,'2020-04-15 16:59:17','2020-04-15 17:39:46',6,2),(11,13,'Dit is een ticket van gebruiker4',3,'2020-04-15 16:59:51','2020-04-15 17:11:05',7,8),(12,7,'gebruiker 4 tweede ticket.',1,'2020-04-15 17:21:02',NULL,7,NULL);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_melding`(IN pGebruikerID INT, pOmschrijving varchar(45))
BEGIN
Insert into tblmeldingen (gebruikerID,omschrijving) values (pGebruikerID,pOmschrijving);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
SELECT id, omschrijving, dtmGemaakt FROM dbhelpdesk.tblmeldingen where (gelezen = 0) and (gebruikerID=pGebruikerID);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `read_tickets_admin` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `read_tickets_admin`(IN pAdminID INT)
BEGIN
SELECT 
t.id as id, 
g.naam as gebruiker,
...
-- Dump completed on 2020-04-15 17:42:18
