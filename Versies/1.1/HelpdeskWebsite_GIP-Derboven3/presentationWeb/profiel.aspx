        ...
        <div class="row">
            <div class="col-lg-12  col-xs-12" style="margin-bottom:8px;">
                ...
                <div class="col-sm-10 col-xs-12" style="padding: 0px;">
                    ...
                    <a href="profile-change-password" class="btn-link">Verander je passwoord</a>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row p-bottom-20">
                        <div class="col-lg-5 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" value="x" readonly>
                            </div>
                        </div>
                    ...
                    <div class="row p-bottom-20">
                        <div class="col-lg-3 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="0000-00-00" disabled>
                            </div>
                        </div>
                        <div class="col-lg-2 col-xs-12">
                            <div class="form-group">
                    ...
                    <div class="row p-bottom-20">
                        <div class="col-lg-11 col-xs-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" style="width: 75%" name="beschrijving_status"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row p-bottom-20">
                        <div class="col-lg-8 col-xs-12">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="meldingen" checked>
