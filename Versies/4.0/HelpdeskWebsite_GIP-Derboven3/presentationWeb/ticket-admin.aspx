<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="ticket-admin.aspx.cs" Inherits="presentationWeb.ticket_admin" %>
                ...
                <div class="table-responsive table-curved" style="border: none; margin: 0px; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                    <asp:GridView CssClass="gridviewcss" ID="gvTickets" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False" ItemStyle-Width="0.7%">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnAccept" runat="server" CommandArgument='<%# Eval("id")+"$"+Eval("status")+"$"+Eval("onderwerp")  %>' CommandName="Accept" Text="" Style="color: dodgerblue;" class="btn btn-mini">
                            ...
                            <asp:TemplateField HeaderText="Status" ItemStyle-Width="15%">
                                <EditItemTemplate>
                                    <asp:Label class="label label-warning" ID="lblEditStatus" runat="server" Text='<%# Bind("status") %>'></asp:Label>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label class="label label-warning" ID="lblStatus" runat="server" Text='<%# Bind("status") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
