...
<asp:Content ID="Content1" ContentPlaceHolderID="main_content_wrapper" runat="server">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb" id="ol_7c49_0">
                    <li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive table-curved" id="div_7c49_0">
                    <asp:GridView CssClass="gridviewcss" ID="gvTickets" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Datum" ItemStyle-Width="15%">
                                <EditItemTemplate>
                                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("dtmGemaakt") %>'></asp:Label>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("dtmGemaakt") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
        ...
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                <div class="col-lg-12 text-center" id="div_7c49_1">
                    <br />
