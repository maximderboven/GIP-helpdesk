...
namespace Domain
{
    public class Ticket
    {
        ...
        //Constructor
        public Ticket(int pid, string pvraag, string pgebruiker, string pcategorie, string ponderwerp, string pstatus, DateTime pdatumgemaakt, DateTime pdatumopgelost)
        {
            _id = pid;
        ...
        public string Vraag { get => _vraag; set => _vraag = value; }
        ...
        {
            return _categorie + " - " + _onderwerp + " op " + _datumGemaakt.ToShortDateString() + " zei " + _gebruiker + " : " + _vraag + " - " + _status;
        }
