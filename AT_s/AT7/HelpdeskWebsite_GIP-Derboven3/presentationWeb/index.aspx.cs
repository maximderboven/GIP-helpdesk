...
namespace presentationWeb
{
    public partial class index : System.Web.UI.Page
    {
        ...
        {
            _business.insert_ticket(Convert.ToInt16(Session["id"]), Convert.ToInt16(ddlNewCategorie.SelectedValue), txtNewOnderwerp.Text, txtNewVraag.Text);
            this.DataBindTickets();
        ...
        protected void gvTickets_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow && gvTickets.EditIndex == e.Row.RowIndex)
            {
                ...
                DropDownList ddlStatus = (e.Row.FindControl("ddlEditStatus") as DropDownList);

                //Add Default Item in the DropDownList
                ddlStatus.Items.Insert(0, new ListItem("- Selecteer -"));
                ...
                string status = (e.Row.FindControl("lblStatus") as Label).Text;
                ddlEditStatus.Items.FindByValue(status).Selected = true;*/
        ...
        {
            int ticketID = Convert.ToInt32(gvTickets.SelectedValue);
            this.DataBindAntwoorden(ticketID);
            gvAntwoorden.Visible = true;
            PanelAntwoorden.Visible = true;
        }
        ...
        protected void gvTickets_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            TextBox vraag = gvTickets.Rows[e.RowIndex].FindControl("txtEditVraag") as TextBox;
            ...
            _business.update_ticket(ticketID, vraag.Text, Convert.ToInt16(categorie.SelectedValue), Convert.ToInt16(status.SelectedValue), onderwerp.Text);
            gvTickets.EditIndex = -1;
            this.DataBindTickets();
        }
